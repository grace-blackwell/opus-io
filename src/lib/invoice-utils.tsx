...
export async function emailInvoiceToContact(
  invoice: InvoicesWithAccountContactContractProject
) {
  try {
    ...
    const subject = `Invoice #${invoice.invoiceNumber} from ${
      invoice.Account?.accountName || "Opus"
    }`;
    ...
    const message = `
            <html>
                <body>
                    ...
                    <p>Please find attached the invoice #${
                      invoice.invoiceNumber
                    } for ${
      invoice.Project?.projectTitle || "our services"
    }.</p>
                    <p>Invoice Details:</p>
                    <ul>
