...
const AccountDetails = ({ data }: Props) => {
  ...
  const handleSubmit = async (formValues: z.infer<typeof FormSchema>) => {
    try {
      console.log(
        "Current form values before creating account data:",
        formValues
      );
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-muted-foreground">
                      Upload your logo or a photo of yourself.
                    </FormDescription>
                    <FormControl>
                      <FileUpload
                        apiEndpoint="logo"
                        ...
                        <Popover open={open} onOpenChange={setOpen}>
                          <PopoverTrigger asChild className="text-left">
                            <Button
                              ...
                              role="combobox"
                              aria-expanded={open}
                              className="bg-input text-muted-foreground border-none justify-between"
                            >
                              {field.value
                                ? States.find(
          ...
          {data?.id && (
            <div className="flex flex-row items-center justify-between rounded-lg border border-destructive gap-4 p-4 mt-4">
              ...
              <div className="text-muted-foreground">
                Deleting your account cannot be undone. This will permanently
