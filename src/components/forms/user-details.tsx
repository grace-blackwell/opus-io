...
import {getAuthUserDetails, saveActivityLogNotification, updateUser} from "@/lib/queries";
...
const userDetails = ({id, userData}: Props) => {
    ...
    const [authUserData, setAuthUserData] = useState<AuthUserWithSidebarOptions | null>(null)
    ...
    const onSubmit = async (values: z.infer<typeof userDataSchema>) => {
        ...
        if (userData || data.user) {
            ...
            await saveActivityLogNotification(userData?.accountId || '', `Updated user details`)
            ...
            if(updatedUser) {
                ...
                toast.error('Oops...', {description: 'Something went wrong while updating user details.'})
            }
        } else {
