...
import { emailInvoiceToContact, sendEmail } from "@/lib/invoice-utils";
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (body.invoice) {
      ...
      const result = await emailInvoiceToContact(invoice);
      ...
      return Response.json(
        {
          success: false,
          message:
            "Invalid request body. Must include either invoice object or sender, recipients, subject, and message.",
        },
        { status: 400 }
      );
    }
