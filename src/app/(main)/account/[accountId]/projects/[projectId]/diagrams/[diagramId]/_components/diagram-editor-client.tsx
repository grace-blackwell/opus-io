...
const DiagramEditorClient = ({ diagram, accountId, projectId }: Props) => {
  ...
  const handleOpenInDrawIo = () => {
    ...
    const url = `https://app.diagrams.net/?url=${encodeURIComponent(
      callbackUrl
    )}&saveAndExit=1`;
    ...
    toast.info(
      'Opening draw.io in a new tab. Your changes will be saved when you click "Save" in the editor.'
    );
  };
      ...
      <div className="flex-grow p-6">
        <Card className="w-full h-full">
          <CardHeader>
            ...
            <CardDescription>
              Click the &quot;Edit in draw.io&quot; button to open the diagram
              in the draw.io editor. Your changes will be saved when you click
              &quot;Save&quot; in the editor.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex items-center justify-center h-[500px]">
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground max-w-md">
                As a temporary solution, you can edit your diagram by opening it
                in a new tab. After editing, click &quot;Save&quot; in the
