...
const ProjectDetailsPage = async ({ params, searchParams }: Props) => {
    ...
    const kanbanId = kanban ? kanban.id : (await db.kanban.create({
        data: {
            name: "Project Kanban",
            accountId: parameters.accountId
        }
                                ...
                                <CardHeader>
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <CardDescription>
                                                {project.Contact?.contactName || 'No Client Assigned'} • Created on {format(new Date(project.createdAt), 'MMM dd, yyyy')}
                                            </CardDescription>
                                        </div>
                                        <Badge 
                                            className={`${
