...
const ProjectKanban = ({ lanes, kanbanId, accountId, projectId, updateLanesOrder, updateTasksOrder }: Props) => {
        ...
        switch (type) {
            ...
            case "task": {
                ...
                if (source.droppableId === destination.droppableId) {
                    ...
                    const destinationProjectTasks = filterTasksByProject(destinationLane.Tasks);
                    ...
                    const updatedOriginLaneTasks = originLane.Tasks.filter(task => task.id !== currentTask.id);
                    originLane.Tasks = updatedOriginLaneTasks;
                    
                    const updatedDestinationLaneTasks = [...destinationLane.Tasks, {...currentTask, laneId: destination.droppableId}];
