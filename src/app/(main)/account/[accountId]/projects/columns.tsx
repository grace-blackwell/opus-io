                ...
                <div className="flex items-center gap-4">
                    {
                        row.original?.Contract ?
                            <Badge className="bg-slate-600 whitespace-nowrap">{contractTitle}</Badge>
                        :
                            'No Contract'
                    }
                </div>
                    ...
                    <div className='flex flex-col gap-2'>
                        {invoices?.length ? (
                            invoices.map((invoice) => (
                                <Badge key={invoice.id} className="bg-slate-600 w-fit whitespace-nowrap">
        ...
        <AlertDialog>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem
                        ...
                        onClick={() => {
                            setOpen(
                                <CustomModal subheading="Enter project details" title="Edit Project Details">
                                    <ProjectDetails
                                ...
                                async () => {
                                    return { user: await getProject(rowData?.id) };
                                }
                            );
                        }}
                    >
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-left">This action cannot be undone. This will permanently delete the project and related data.</AlertDialogDescription>
                </AlertDialogHeader>
